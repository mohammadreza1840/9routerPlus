...
> 🎬 **¿Has hecho un video sobre 9Router?** Envía una [Pull Request](https://github.com/mohammadreza1840/9routerPlus/pulls) añadiendo tu video a esta sección — ¡lo fusionaremos!
...
docker pull mohammadreza1840/9routerPlus:latest   # actualiza a la última versión
```
...
- **Problemas**: [github.com/mohammadreza1840/9routerPlus/issues](https://github.com/mohammadreza1840/9routerPlus/issues)
