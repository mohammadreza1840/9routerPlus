...
docker run -d \
  ...
  ghcr.io/mohammadreza1840/9routerPlus:latest
```
...
MIT License — lihat [LICENSE](https://github.com/mohammadreza1840/9routerPlus/blob/main/LICENSE) untuk detailnya.

---

<div align="center">

**Kalau 9Router membantumu, kasih ⭐ di [GitHub](https://github.com/mohammadreza1840/9routerPlus)!**

[🌐 Website](https://9router.com) • [📦 npm](https://www.npmjs.com/package/9router) • [🐛 Laporkan Bug](https://github.com/mohammadreza1840/9routerPlus/issues)
